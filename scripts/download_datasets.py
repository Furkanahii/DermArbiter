...
def download_ddi(target_dir: Path, **_kw) -> DownloadReport:
    ...
    msg = (
        ...
        "Source (Stanford AIMI — free registration + Research Use Agreement):\n"
        "  https://stanfordaimi.azurewebsites.net/datasets/"
        "35866158-8196-48d8-87bf-50dca81df965\n"
        "  (canonical landing page: https://ddi-dataset.github.io/)\n\n"
        "656 images / 570 patients, Fitzpatrick I-VI, biopsy-confirmed.\n"
        "Acknowledge Stanford AIMI in publications; do not reshare the link.\n\n"
        "Steps:\n"
        "  1. Register as an individual, accept the Research Use Agreement,\n"
        "     then download the DDI archive.\n"
